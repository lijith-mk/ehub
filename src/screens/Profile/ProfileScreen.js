  ...
  const handleLogout = () => {
    Alert.alert('Sign Out', 'Are you sure you want to sign out?', [
      { text: 'Cancel', style: 'cancel' },
      {
        ...
        style: 'destructive',
        onPress: () => {
          // Clear storage then go to Login
          // Use navigate instead of dispatch/reset to avoid navigator scope issues
...
const styles = StyleSheet.create({
  ...
  headerBg: {
    alignItems: 'center', paddingTop: 30, paddingBottom: 28,
  ...
  avatar: {
    width: 86, height: 86, borderRadius: 28, backgroundColor: COLORS.primary,
    justifyContent: 'center', alignItems: 'center', marginBottom: 14,
    shadowColor: COLORS.primary, shadowOpacity: 0.4, shadowRadius: 16,
    shadowOffset: { width: 0, height: 8 }, elevation: 10,
  },
  avatarText: { fontSize: 30, fontWeight: '800', color: '#fff', letterSpacing: -0.5 },
  name: { fontSize: 22, fontWeight: '800', color: COLORS.text, letterSpacing: -0.3 },
  email: { fontSize: 14, color: COLORS.textLight, marginTop: 4, marginBottom: 14 },
  editBtn: { paddingHorizontal: 22, paddingVertical: 9, borderRadius: 12, borderWidth: 1.5, borderColor: COLORS.primary },
  ...
  statLabel: { fontSize: 12, color: COLORS.textLight, fontWeight: '500', marginTop: 3 },
  ...
  menuSubtitle: { fontSize: 12, color: COLORS.textLight, marginTop: 1 },
});
